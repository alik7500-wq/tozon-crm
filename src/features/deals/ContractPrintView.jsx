                ...
                <tbody className="divide-y divide-slate-950 font-serif">
                  <tr>
                    ...
                    <td className="p-3 align-top space-y-2 text-slate-950">
                      ...
                      <p className="text-[11px]"><strong>{isTJ ? 'РМА:' : 'ИНН:'}</strong> {deal.inn || '—'}</p>
